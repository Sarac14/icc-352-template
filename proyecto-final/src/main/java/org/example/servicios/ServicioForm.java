...
import org.example.util.TablaFormulario;
...
public class ServicioForm {
    ...
    public List<Formulario> listarFormulario(){
        ...
        //
        MongoCollection<Document> formularios = mongoDbConexion.getBaseDatos().getCollection(TablaFormulario.formulario.getValor());
        ...
        while (iterator.hasNext()){
            ...
            formulario.setLongitud(next.getString("agente"));
